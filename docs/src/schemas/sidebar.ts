...
const linkHTMLAttributesSchema = z.record(z.union([z.string(), z.number(), z.boolean(), z.undefined()])) as z.Schema<
...
type ManualSidebarGroupInput = z.input<typeof SidebarGroupSchema> & {
  ...
  items: Array<z.input<typeof SidebarLinkItemSchema> | z.input<typeof AutoSidebarGroupSchema> | ManualSidebarGroupInput>
}

type ManualSidebarGroupOutput = z.output<typeof SidebarGroupSchema> & {
  /** Array of links and subcategories to display in this category. */
  items: Array<
    z.output<typeof SidebarLinkItemSchema> | z.output<typeof AutoSidebarGroupSchema> | ManualSidebarGroupOutput
  >
}

const ManualSidebarGroupSchema: z.ZodType<ManualSidebarGroupOutput, z.ZodTypeDef, ManualSidebarGroupInput> =
  SidebarGroupSchema.extend({
    /** Array of links and subcategories to display in this category. */
    items: z.lazy(() => z.union([SidebarLinkItemSchema, ManualSidebarGroupSchema, AutoSidebarGroupSchema]).array()),
  })

export const SidebarItemSchema = z.union([SidebarLinkItemSchema, ManualSidebarGroupSchema, AutoSidebarGroupSchema])
