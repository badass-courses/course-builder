		...
		<div>
			...
			>
				{emotions.map((emotion) => (
					<div
						key={emotion}
						className="*:radix-state-checked:bg-border *:radix-state-unchecked:hover:bg-border/50 *:radix-state-checked:shadow-inner relative h-10 w-10 first-of-type:rounded-l-md last-of-type:rounded-r-md [&_svg]:absolute [&_svg]:left-1 [&_svg]:top-0 [&_svg]:w-1"
					>
						<RadioGroupItem
							value={emotion}
							id={emotion}
		...
		<div>
			...
			>
				{categories.map((category) => (
					<div
						className="*:radix-state-checked:bg-border *:radix-state-unchecked:hover:bg-border/50 *:radix-state-checked:shadow-inner relative h-10 first-of-type:rounded-l-md last-of-type:rounded-r-md [&_svg]:absolute  [&_svg]:left-1 [&_svg]:top-0 [&_svg]:w-1"
						key={category}
					>
						<RadioGroupItem
							value={category}
