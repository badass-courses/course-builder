...
export type CopyAsMarkdownProps = ComponentProps<typeof DropdownMenuItem>

/**
 * Copies the query content to clipboard as markdown.
 * Shows a brief checkmark confirmation when copied successfully.
 */
export const CopyAsMarkdown = (props: CopyAsMarkdownProps) => {
	const { query } = useOpenInContext()
	...
	return (
		...
		>
			...
			<span className="flex-1">{copied ? 'Copied!' : 'Copy as Markdown'}</span>
		</DropdownMenuItem>
	)
}
