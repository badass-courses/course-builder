import cookies from '@coursebuilder/utils-browser/cookies'
...
/**
 * Get player preferences from cookies.
 * Returns default preferences if on server or no preferences stored.
 */
