...
import { CourseBuilderAdapter } from '../dist/adapters'
import { VideoResource } from '../dist/schemas/video-resource'
import { ContentResource } from '../dist/types'
...
export function MemoryAdapter(memory?: Memory): CourseBuilderAdapter {
	...
	Object.assign(adapter, {
		...
		async getContentResource(id: string): Promise<ContentResource | null> {
			return null
		},
		async getVideoResource(id: string): Promise<VideoResource | null> {
			return null
		},
