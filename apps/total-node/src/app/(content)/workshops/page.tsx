...
export const metadata: Metadata = {
	title: `Total Node.js Workshops by ${config.author}`,
	openGraph: {
		images: [
			{
				url: `${env.NEXT_PUBLIC_URL}/api/og?title=${encodeURIComponent(`Total Node.js Workshops by ${config.author}`)}`,
			},
		],
	},
}
			...
			<div className="mx-auto flex h-full w-full max-w-screen-lg flex-col items-center border-x">
				<div className="w-full px-5 pb-16 pt-24">
					<h1 className="font-heading fluid-3xl text-center font-medium">
						Professional Next.js Workshops
					</h1>
				</div>
