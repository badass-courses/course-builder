...
export async function GET(request: Request) {
	try {
		...
		return new ImageResponse(
			(
				<div
					tw="flex h-full w-full bg-[#009A52] text-white flex-col p-8 relative"
					style={{
						fontFamily: 'Maison',
						width: 1200,
						height: 630,
				...
				>
					<div tw="absolute w-full h-full left-8 top-8 border-4 border-black rounded-xl" />
					{/* TODO: Add a logo */}
					...
					<main tw="flex p-20 pb-24 flex-row w-full h-full flex-grow items-end justify-between">
