...
export default function TagManagement({
	...
	initialTags: EggheadTag[]
}) {
	const [tags, setTags] = useState<EggheadTag[]>(initialTags)
	...
	const handleCreate = (newTag: EggheadTag) => {
		setTags([...tags, newTag])
	}

	const handleEdit = (updatedTag: EggheadTag) => {
	...
	return (
		<div className="min-h-screen py-10">
			<div>
				<h1 className="mb-8 text-3xl font-bold text-gray-200">
					Tag Management
				</h1>
