	...
	return (
		<Comp>
			<Image
				...
				height={270}
				className={cn(
					'ring-gray-800/7.5 rounded-lg shadow-[0px_4px_38px_-14px_rgba(0,_0,_0,_0.2)] ring-1 brightness-100 transition duration-300 ease-in-out group-hover:brightness-105 dark:brightness-90',
					className,
				)}
