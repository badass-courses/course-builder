		...
		>
			<Pricing.Product className="w-full">
				...
				<Pricing.Details className="px-0">
					...
					<Pricing.BuyButton className="dark:bg-primary font-heading dark:hover:bg-primary/90 from-primary relative mt-3 h-16 max-w-xs cursor-pointer rounded-lg bg-gradient-to-b to-indigo-800 text-xl font-bold tracking-tight shadow-xl transition duration-300 ease-out hover:bg-blue-700 hover:brightness-110">
