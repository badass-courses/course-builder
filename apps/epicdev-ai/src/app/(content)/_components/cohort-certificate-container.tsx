...
export const Certificate = ({
	...
	return isCompleted ? (
		<CohortCertificate.Root resourceIdOrSlug={resourceSlugOrId}>
			<CohortCertificate.Trigger className="text-foreground hover:bg-muted bg-background aspect-842/595 relative flex h-fit w-full flex-col gap-2 rounded-md border">
		...
		<div className="bg-background aspect-842/595 relative flex h-fit w-full flex-col items-center justify-center rounded-md border text-sm">
