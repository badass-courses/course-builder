...
export const env = createEnv({
	...
	server: {
		...
		INNGEST_APP_NAME: z.string().optional(),
	...
	client: {
		...
		NEXT_PUBLIC_PARTYKIT_ROOM_NAME: z.string().optional(),
		NEXT_PUBLIC_PARTY_KIT_URL: z.string().optional(),
		NEXT_PUBLIC_URL: z.string().optional(),
		NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME: z.string().optional(),
		NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET: z.string().optional(),
		NEXT_PUBLIC_SUPPORT_EMAIL: z.string().optional(),
		NEXT_PUBLIC_SUPPORT_PHYSICAL_ADDRESS: z.string().optional(),
