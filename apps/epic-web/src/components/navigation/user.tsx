...
export const User: React.FC<{ className?: string }> = ({ className }) => {
	...
	if (isLoadingUserInfo || !sessionData?.user?.email) {
		return null
	}

	// For now, just assume the user can't create content
	// We'll enable this when TRPC is properly set up and working
