...
export function ResourceHeader({
	...
	return (
		<header
			className={cn(
				'flex w-full flex-col items-center justify-between py-5 md:gap-10 lg:flex-row lg:py-8',
				className,
			)}
		>
				...
				{badge && (
					<div className="pb-5">
						{badge.href ? (
							<Link
								href={badge.href}
								className="bg-primary/20 text-primary inline-flex items-center gap-1 rounded-full px-3 py-0.5 text-sm"
							>
