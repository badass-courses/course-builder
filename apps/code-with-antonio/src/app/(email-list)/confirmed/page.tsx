...
export default async function ConfirmedSubscriptionPage({
	...
	return (
		<LayoutClient withContainer>
			...
			<main className="flex min-h-[calc(100dvh-var(--nav-height))] grow flex-col items-center justify-center">
				<div className="max-w-lg text-center font-light">
					<h1 className="font-heading py-8 text-4xl font-bold lg:text-5xl">
						You&apos;re Subscribed
					</h1>
					<p className="mx-auto text-balance pb-8 leading-relaxed sm:text-xl">
