    ...
    <>
      ...
      <ResizablePanelGroup direction="horizontal" className="!flex-col border-t md:!flex-row">
        ...
        {Boolean(transcriptWithScreenshots) && (
          <>
            {/*TODO: extract into component - this is probably a "widget" */}
            <ResizablePanel
              defaultSize={20}
              minSize={1}
              maxSize={50}
        ...
        <EditResourcesToolPanel resource={{ ...tip, ...form.getValues() }} />
      </ResizablePanelGroup>
    </>
  )
}
...
const TipMetadataFormFields: React.FC<{
  form: UseFormReturn<z.infer<typeof TipSchema>>
  videoResourceLoader: Promise<VideoResource | null>
  tip: Tip
