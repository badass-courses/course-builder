...
import {
  ...
  type VideoDeepgramWebhook,
} from '@/inngest/video-processing/events/video-deepgram-webhook'
...
import {
  type VIDEO_TRANSCRIPT_READY_EVENT,
  type VideoTranscriptReady,
} from '@/inngest/video-processing/events/video-transcript-requested'
...
type Events = {
  ...
  [DEEPGRAM_WEBHOOK_EVENT]: VideoDeepgramWebhook
