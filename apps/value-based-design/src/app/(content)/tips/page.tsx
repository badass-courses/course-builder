...
export const metadata: Metadata = {
	title: `Tips by ${config.author}`,
	openGraph: {
		images: [
			{
				url: `${env.NEXT_PUBLIC_URL}/api/og?title=${encodeURIComponent(`Tips by ${config.author}`)}`,
			},
		],
	},
}
	...
	return (
		<main className="container relative flex h-full min-h-[calc(100vh-var(--nav-height))] flex-col items-center px-0 lg:border-x">
			<div className="w-full max-w-screen-md border-b py-16">
				<h1 className="font-heading fluid-3xl text-center font-medium">Tips</h1>
			</div>
			<TipList />
			<Suspense>
				<TipListActions />
