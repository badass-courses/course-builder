...
/**
 * Helper function to trigger sync when resources are reordered in a cohort
 */
export async function triggerResourceReorderedSync(
	cohortId: string,
	reorderedResources: Array<{
		resourceId: string
		oldPosition: number
		newPosition: number
	}>,
	...
	return triggerCohortEntitlementSync(cohortId, {
		resourcesReordered: reorderedResources,
	})
}
