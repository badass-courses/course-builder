		...
		<div>
			...
			>
				{emotions.map((emotion) => (
					<div
						key={emotion}
						className="[&>[data-state=checked]]:bg-border hover:[&>[data-state=unchecked]]:bg-border/50 relative h-10 w-10 first-of-type:rounded-l-md last-of-type:rounded-r-md [&>[data-state=checked]]:shadow-inner [&_svg]:absolute [&_svg]:left-1 [&_svg]:top-0 [&_svg]:w-1"
					>
						<RadioGroupItem
							value={emotion}
							id={emotion}
		...
		<div>
			...
			>
				{categories.map((category) => (
					<div
						className="[&>[data-state=checked]]:bg-border hover:[&>[data-state=unchecked]]:bg-border/50 relative h-10 first-of-type:rounded-l-md last-of-type:rounded-r-md [&>[data-state=checked]]:shadow-inner [&_svg]:absolute  [&_svg]:left-1 [&_svg]:top-0 [&_svg]:w-1"
						key={category}
					>
						<RadioGroupItem
							value={category}
