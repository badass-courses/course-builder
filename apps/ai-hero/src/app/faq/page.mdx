...
export default ({children}) => (
	<div>
		...
		<main className="mx-auto mt-5 w-full max-w-screen-lg p-5 pb-32">
			<article className="prose mx-auto grid max-w-screen-lg grid-cols-1 sm:prose-lg   sm:gap-8 sm:prose-headings:mt-0 sm:prose-headings:font-semibold  md:grid-cols-2 md:gap-12 lg:gap-16">
				{children}
			</article>
		</main>
	</div>
