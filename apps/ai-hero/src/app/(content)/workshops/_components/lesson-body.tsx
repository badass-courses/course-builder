...
export function LessonBody({
	...
	if (!canView) {
		return (
			<div className="prose dark:prose-invert dark:prose-a:text-primary prose-a:text-blue-600 lg:prose-lg max-w-none">
				<p>
	...
	return (
		<div className="prose-img:rounded-lg dark:prose-invert prose dark:prose-a:text-primary prose-a:text-blue-600 lg:prose-pre:text-sm lg:prose-pre:leading-relaxed lg:prose-lg max-w-none">
			{content}
		</div>
	)
}
