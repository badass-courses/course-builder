			...
			(
				...
				>
					...
					<div tw="flex items-center justify-center absolute left-26 top-26">
						<img
							src="https://res.cloudinary.com/dbdlunqwz/image/upload/v1769787824/dan-abramov_fpfcze.png"
							width={200}
							height={200}
						/>
						<div tw="flex flex-col">
							<span tw="text-[48px] leading-none font-bold">Just React</span>
							<span
								tw="text-[24px] font-light"
					...
					<main tw="flex p-26 pb-32 relative z-10 flex-row w-full h-full grow items-end justify-between">
						<div
							tw={`${resource?.type === 'post' ? 'text-[62px]' : resource?.type === 'workshop' ? 'text-[42px]' : 'text-[56px]'} min-w-[500px] leading-tight pr-16`}
						>
							{title}
						</div>
