...
export default {
	'newsletter-subscribed-logged-in': ({
		...
		return (
			<>
				...
				<Link className="underline underline-offset-2" href={resource?.path}>
					{resource?.title}
				</Link>
				.
			</>
	...
	'primary-newsletter-byline': `In exchange for your email address, you'll get full access to all dev.build tutorials.`,
