...
<QuestionAndAnswer className='mt-14 sm:mt-0'>
...
<div className="prose-p:text-body-text mx-auto mt-48 max-w-2xl text-balance text-center">
...
<MoreClearAsVisualization className="pt-6" />
