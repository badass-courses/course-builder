...
<SnippetWithGlow className="mt-14 sm:mt-20 md:mt-24 lg:mt-28" />

<CurvedLineIntersection positionClassName="left-[15%] right-[15%]  sm:left-20 sm:right-1/2 md:left-[calc((50%-8px)/2)] md:right-[calc(50%)]" />
...
<CurvedLineIntersection positionClassName="left-[15%] right-[15%] sm:left-36 sm:right-[calc((50%-8px)/2)]" />
...
<QuestionAndAnswer className="mt-14 sm:mt-4">
...
<Introducing className="mt-[70px] sm:mt-20 md:mt-28" />
...
<div className="prose-p:text-body-text prose-xl prose-p:leading-[1.6] mx-auto mt-20 max-w-2xl text-balance text-center sm:mt-28 md:mt-36 lg:mt-48">
...
<PrimaryNewsletterCta className="mt-[70px] sm:mt-28 md:mt-36 lg:mt-48 xl:mt-64" />
...
<CurvedLineIntersection
	positionClassName="left-[15%] right-[15%] sm:left-1/4 sm:right-1/4"
