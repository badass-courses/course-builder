...
<SnippetWithGlow className="mt-14 md:mt-28" />

<CurvedLineIntersection
	positionClassName="left-[calc((50%-8px)/2)] right-[calc(50%)]"
	className=" hidden md:block"
/>

<div className="mt-[70px] grid gap-6 sm:gap-4 md:mt-0 lg:grid-cols-2">
...
<CurvedLineIntersection
	positionClassName="left-36 right-[calc((50%-8px)/2)] hidden md:block"
	className=" hidden md:block"
/>

<QuestionAndAnswer className='mt-14 sm:mt-0 bg-transparent p-0 sm:bg-jsv-charcoal sm:p-24 rounded-none sm:rounded-[2.5rem]'>
...
<QuestionAndAnswer className="mt-14 sm:mt-4 bg-transparent p-0 sm:bg-jsv-charcoal sm:p-24 rounded-none sm:rounded-[2.5rem]">
...
<Introducing className="mt-[70px] sm:mt-28" />

<IntroduceAuthor className="mt-12 sm:mt-24">
### Hi, I'm Lydia Hallie
...
<WhatYouWillLearn className="mt-9 sm:mt-20" />

<div className="prose-p:text-body-text prose-xl sm:prose-lg prose-p:leading-[1.6] mx-auto mt-20 max-w-2xl text-balance text-center sm:mt-48">
...
<PrimaryNewsletterCta className="mt-[70px] sm:mt-64" />

<QuestionAndAnswer className='mt-9 sm:mt-6 bg-transparent p-0 sm:bg-jsv-charcoal sm:p-24 rounded-none sm:rounded-[2.5rem]'>
...
<CurvedLineIntersection
	className=" hidden md:block"
	positionClassName="left-1/4 right-1/4 hidden md:block"
	startColor="rgba(255, 87, 134, 0.5)"
	endColor="rgba(90, 102, 110, 0.5)"
/>

<MoreClearAsVisualization className="mt-10 sm:mt-6" />
