...
> = ({
	...
	return (
		<SectionWrapper
			...
			className={cn(
				'not-prose relative flex flex-col items-center gap-8 bg-[linear-gradient(280deg,rgba(155,55,255,1)_15.97%,rgba(246,59,115,1)_45.03%,rgba(246,115,59,1)_84.46%)] md:flex-row md:items-start',
				className,
			)}
		>
